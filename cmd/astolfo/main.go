...
func main() {
	...
	generatedPassword, err := astolfo.GeneratePassword(userName, siteName, passwd, passLength, passCounter, uppercase, lowercase, punctuation, digits)
	if err != nil {
		die(err, &exitCode, 4)
		return
	}
